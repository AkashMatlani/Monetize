import { formatCurrency, formatDateSubscrptionDateTime, formatSatusLabel } from '@/lib/utills'
import clsx from 'clsx'
import React from 'react'
import { Image, Pressable, Text, View } from 'react-native'

const SubscrptionCard = ({ name, price, currency, icon, billing, color, category, plan, renewalDate, expanded, onPress, paymentMethod, startDate, status }: SubscrptionCardProps) => {
    return (
                ...
                <View className='sub-main'>
                    ...
                    <View className='sub-copy'>
                        ...
                        <Text numberOfLines={1} ellipsizeMode='tail' className='sub-meta'>
                            {category?.trim()
                                || plan?.trim() ||
                                (renewalDate ? formatDateSubscrptionDateTime(renewalDate) : '')}
                        </Text>
                    </View>
                </View>
...
export default SubscrptionCard